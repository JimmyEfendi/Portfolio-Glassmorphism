...
function parseMarkdown(text) {
  ...
  (function() {
      ...
      launchButton.innerHTML = `
          ...
          <span class="chat-launcher-text">AI Assistant</span>`;
      ...
      async function handleRegistration(event) {
          ...
          try {
              ...
              // Gunakan parseMarkdown untuk mengubah ** menjadi <strong>
              botMessage.innerHTML = parseMarkdown(linkifyText(messageText));
              messagesContainer.appendChild(botMessage);
              ...
              errorMessage.textContent = "Halo... Dengan saya Jimmy AI Agent. Ada yang bisa saya bantu?";
      ...
      async function submitMessage(messageText) {
          ...
          try {
              ...
              // Terapkan parseMarkdown agar **bold** berubah menjadi <strong>
              botMessage.innerHTML = parseMarkdown(linkifyText(responseText));
              messagesContainer.appendChild(botMessage);
              messagesContainer.scrollTop = messagesContainer.scrollHeight;
          } catch (error) {
